 ...
 * 03.11.2017
 * 
 * Dieses Klasse bietet eine Annuitäten- sowie eine Ratentilgungsrechnung in Tabellendarstellung.
 * Die dargestellten Werte sind Jahr, Restschuld am Jahresanfang, Zinsen, Tilgung sowie Rate pro Jahr für beide Rechnungen.
 * 
...
public class Aufgabe1 {
	 ...
	 * @param rate: Rate
	 * @param laengsteZahl: größte / längste Zahl
	 */
	...
	/**
	 * Diese Methode passt die Länge der Spalten so an, dass keine Verschiebung
	 * auftritt und jede Spalte nur so groß ist, wie ihre größte / längste Zahl.
	 * 
	 ...
	 * 						nicht größer)
	 * @return: Gibt den angepassten String zurück. 
